...
| :--- | :--- |
| **Linguagens** | Python, SQL (PostgreSQL, MySQL), TypeScript |
| **Data Engineering** | Apache Spark, ETL Pipelines, Pandas |
| **Cloud (AWS)** | S3, EC2, IAM, RDS, VPC, Glue |
| **Bancos de Dados** | MongoDB, PostgreSQL, SQL Server |
...
---
*“A jornada em dados é constante e a curiosidade é o meu principal motor.”*
